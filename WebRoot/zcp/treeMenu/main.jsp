    ...
    $(function () {
        $("#dg").datagrid({
            ...
            columns : [[
                ...
                {field:'createTime',title:'创建时间',width:fixWidth(0.4)}
            ]],
            toolbar: [{
                iconCls: 'icon-add',
                text: '添加',
                handler: function(){
                    ...
                    $('#add').dialog({
                        ...
                        cache: false,
                        resizable:true,
                        href: '${pageContext.request.contextPath}/department.jsp',
                        modal: true
                    });
//                    $('#dd').dialog('refresh', 'new_content.php');
                ...
                iconCls: 'icon-edit',
                text: '修改',
                handler: function(){$.messager.alert('提示','修改按钮','info');}
            },'-',{
                iconCls: 'icon-remove',
                text: '删除',
                ...
                iconCls: 'icon-search',
                text: '查看',
                handler: function(){$.messager.alert('提示','查看按钮','info');}
            }],
